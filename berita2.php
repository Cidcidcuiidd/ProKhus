        ...
        <div id="templatemo_content">
						...
						$dataPerPage = 1;
							...
							{	
								...
								echo '<tr><center><img src="images/'.$data ['gbr_berita'].'" width="250" height="250"/></center></tr>';
								echo "<p>" .$isi. "</p><br></br>";							
								//echo '<p align="right" >' ."<a href='berita2.php?id=$idberita'>Continue Reading &raquo </a>". '</p><br></br>';
							}
